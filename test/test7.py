...
postseed = '? Give me top 5 results, if there arent 5 then give only those that are relevant and do not show what doesnt exist in the provided JSON. Give the answer in the following JSON format where product is the product name(the name field in the json), and reason is the reason that product is a good fit for the question asked [{"product-name" : "", "reason" : ""}, {"product-name" : "", "reason" : ""}, etc]. Give the answer in the provided JSON format only'

seed = 'The provided JSON is a list of products, only provide the name of the product, not the features. Limit yourself to only the JSON provided, Give the top 5 results, if there arent 5 then give only those that are relevant and do not show what doesnt exist in the provided JSON. Give the answer in the following JSON format product is the product-name and reason is the reason that product is a good fit for the question asked [{"product-name" : "", "reason" : ""}, {"product-name" : "", "reason" : ""}, ... ]. Give the answer in the provided JSON format only The question is: '
